...
export const agreementAction = (action: AgreementActionType, payload: AgreementState) => {
  return {
    type: action,
    payload: payload
  } as {
...
export const agreementReducer = (state: AgreementState = initialState, action: AgreementAction): AgreementState => {
  switch (action.type) {
